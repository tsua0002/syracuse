...
- Non-empty compressed trajectories: `990`
- Mean exponent: `2.4127`
- Mean frequency of exponent `1`: `0.4060`
- Mean net log2 growth budget: `-7.8240`
- Threshold $\log_2(3)$: `1.5850`

Extremal examples:

- Longest compressed trajectory: `n=871`, `compressed_length=65`, `mean_exponent=1.7385`, `net_log2_factor=-9.9774`
